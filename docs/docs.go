    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/platform.TwitchDeviceLogin"
                        }
                    },
                    "502": {
        ...
        "/config/twitch-login/poll": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Device code from the start of the login",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.PollTwitchLoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.PollTwitchLoginResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
